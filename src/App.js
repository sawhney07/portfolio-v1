    ...
    <div className="flex flex-col justify-center bg-white">
        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow justify-center w-full text-center bg-white max-md:max-w-full">
              <div className="flex justify-center items-center px-16 py-12 text-4xl font-semibold text-blue-700 bg-neutral-900 max-md:px-5 max-md:max-w-full">
              ...
              <div className="flex justify-center items-center px-16 py-20 font-bold bg-neutral-900 max-md:px-5 max-md:max-w-full">
                <div className="flex flex-col items-center mt-28 mb-16 max-w-full w-[658px] max-md:my-10">
                  ...
                  <div className="self-stretch mt-20 text-2xl text-neutral-200 max-md:mt-10 max-md:max-w-full">
                    ...
                    Maxime consequatur unde sint expedita, repellat temporibus
                    ...
                    temporibus asperiores eveniet eaque a dignissimos! Natus
                    dicta sapiente, cum incidunt odit voluptates veniam
                    aspernatur nostrum!
                  </div>
                  <div className="justify-center items-center px-16 py-8 mt-16 max-w-full text-3xl bg-blue-700 rounded-[50px] text-zinc-100 text-opacity-90 w-[300px] max-md:px-5 max-md:mt-10">
                    Contact Me
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow justify-center w-full bg-neutral-900 max-md:max-w-full">
              <div className="flex justify-center items-center px-16 py-16 text-2xl font-semibold text-center text-blue-700 whitespace-nowrap bg-neutral-900 max-md:px-5 max-md:max-w-full">
              ...
              <div className="flex justify-center items-center px-16 py-20 bg-neutral-900 max-md:px-5 max-md:max-w-full">
                <img
                  ...
                  className="mt-14 mb-20 max-w-full aspect-square w-[600px] max-md:my-10"
                />
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 w-full max-w-[1548px] max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
              <img
                loading="lazy"
                srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/a0e9143540c3d127e5d2eb5c77edb0ca164788bfc431ecbc0fbf6a9ccb2a4006?apiKey=a2ae5ec7e5544df495302e8dcdfc0e04&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/a0e9143540c3d127e5d2eb5c77edb0ca164788bfc431ecbc0fbf6a9ccb2a4006?apiKey=a2ae5ec7e5544df495302e8dcdfc0e04&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/a0e9143540c3d127e5d2eb5c77edb0ca164788bfc431ecbc0fbf6a9ccb2a4006?apiKey=a2ae5ec7e5544df495302e8dcdfc0e04&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/a0e9143540c3d127e5d2eb5c77edb0ca164788bfc431ecbc0fbf6a9ccb2a4006?apiKey=a2ae5ec7e5544df495302e8dcdfc0e04&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/a0e9143540c3d127e5d2eb5c77edb0ca164788bfc431ecbc0fbf6a9ccb2a4006?apiKey=a2ae5ec7e5544df495302e8dcdfc0e04&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/a0e9143540c3d127e5d2eb5c77edb0ca164788bfc431ecbc0fbf6a9ccb2a4006?apiKey=a2ae5ec7e5544df495302e8dcdfc0e04&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/a0e9143540c3d127e5d2eb5c77edb0ca164788bfc431ecbc0fbf6a9ccb2a4006?apiKey=a2ae5ec7e5544df495302e8dcdfc0e04&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/a0e9143540c3d127e5d2eb5c77edb0ca164788bfc431ecbc0fbf6a9ccb2a4006?apiKey=a2ae5ec7e5544df495302e8dcdfc0e04&"
                className="mt-48 w-full aspect-square max-md:mt-10 max-md:max-w-full"
              />
            </div>
            <div className="flex flex-col ml-5 w-[67%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col font-bold text-center max-md:mt-10 max-md:max-w-full">
                <div className="text-5xl text-blue-700 max-md:max-w-full max-md:text-4xl">
                  Get to Know Me
                </div>
                <div className="flex flex-col self-end mt-44 max-w-full w-[676px] max-md:mt-10">
                  <div className="text-2xl text-neutral-200 max-md:max-w-full">
                    <span className="text-5xl text-blue-700">Lorem</span> ipsum
                  ...
                  <div className="justify-center items-center self-center px-16 py-8 mt-20 max-w-full text-3xl bg-blue-700 rounded-[50px] text-zinc-100 text-opacity-90 w-[300px] max-md:px-5 max-md:mt-10">
                    Contact Me
                  </div>
                </div>
              </div>
      ...
      <div className="flex justify-center items-center px-16 py-20 w-full bg-neutral-900 max-md:px-5 max-md:max-w-full">
        <div className="flex flex-col w-full max-w-[1694px] max-md:max-w-full">
          <div className="self-center text-5xl font-bold text-center text-blue-700 max-md:max-w-full max-md:text-4xl">
            Some of my Projects
          </div>
            ...
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow p-6 w-full font-bold text-center bg-stone-50 rounded-[50px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
                  ...
                  <div className="justify-center items-center px-16 py-7 mt-7 text-3xl text-white whitespace-nowrap bg-blue-700 rounded-[30px] max-md:px-5 max-md:max-w-full">
                    View
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow px-20 py-20 mt-3 w-full text-2xl font-bold text-center whitespace-nowrap bg-neutral-900 bg-opacity-10 text-zinc-100 max-md:px-5 max-md:mt-10 max-md:max-w-full">
                  <div className="self-center text-3xl text-blue-700">
                    E-Mail
                  </div>
